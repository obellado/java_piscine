...
//    private static final String DB_DATA = "/resources/data.sql";
    ...
    public void update(Object o) throws IllegalAccessException, SQLException {
            ...
            for (Field f : fields){
                ...
                if (f.isAnnotationPresent(OrmColumn.class)) {
                    ...
                    if(f.getType().getSimpleName().equals("String")){
                        sql.append("'").append(f.get(entity)).append("', ");
                    } else {
                        sql.append(f.get(entity)).append(", ");
                    }
    ...
    public void save(Object o) throws SQLException, IllegalAccessException {
        Class<?> class_ = o.getClass();
        if (class_.isAnnotationPresent(OrmEntity.class)) {
            OrmEntity entity = class_.getAnnotation(OrmEntity.class);
